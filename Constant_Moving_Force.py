...
boundary    = PMLRailDampVertic(l_bound = 2.0)     # 33.0 m boundary domain

# Define excitation (Gaussian impulse between sleepers at 10m)
excitation  = ConstantForce(x_excit = 20.0)      # NOTE: why is the excitation position halved?
...
# 4.3 Plot mobility frequency response
resp.plot(
