...
starting_position         = 40.0    # Starting position [m]
num_mount                 = 300     # Number of discrete mounting positions
distance                  = 0.6     # Distance between sleepers [m]
l_bound                   = 20.0    # Width of boundary domain
dt                        = 2.2e-5  # Time step [s]
# velocities                = [vel for vel in range(10,101,10)]    # Velocities to simulate [m/s] NOTE: always give a list, even for a single velocity
velocities                = [60]    
